...
export function DatasetFileField({ fileName, onChange, accent = 'emerald' }) {
  return (
    <div className="flex flex-col gap-1">
      <Label htmlFor="dataset-file">Tus frases (archivo CSV)</Label>
      <FileInput id="dataset-file" accept=".csv" onChange={onChange} accent={accent} />
      <p className="text-xs text-slate-500">
        Debe tener una columna "frase". No hace falta que las clasifiques tú: el modelo agrupa solo las que se parecen entre sí.
      </p>
      {fileName && (
